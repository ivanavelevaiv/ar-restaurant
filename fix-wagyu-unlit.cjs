// Converts KHR_materials_unlit materials in wagyu.glb to standard PBR
// Identical fix to fix-burger-unlit.cjs — iOS Quick Look drops unlit materials.
...
async function main() {
    ...
    const doc = await io.read('models/wagyu.glb');
    ...
    await io.write('models/wagyu-raw.glb', doc);
    console.log(`Done: ${converted} material(s) converted → models/wagyu-raw.glb`);
}
