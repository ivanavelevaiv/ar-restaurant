// Converts KHR_materials_unlit materials in prvo.glb to standard PBR
// Same fix as fix-burger-unlit.cjs and fix-wagyu-unlit.cjs —
// iOS Quick Look silently drops unlit materials during USDZ conversion.
...
async function main() {
    ...
    const doc = await io.read('models/prvo.glb');
    ...
    await io.write('models/prvo-raw.glb', doc);
    console.log(`Done: ${converted} material(s) converted → models/prvo-raw.glb`);
}
